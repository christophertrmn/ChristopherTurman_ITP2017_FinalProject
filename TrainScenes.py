...
def trainscene1():
    ...
    background = imagesprite("graphics\\background\\trainstation.png",0,0)
    ...
    maya = imagesprite("graphics\\character\\Maya\\MayaCasual1.png",-150,0)
    mayar = imagesprite("graphics\\character\\Maya\\MayaCasual1.png",350,0)
...
def trainscene2():
    ...
    dialogue6=  textsprite("gamefont\\ITCBLKAD.TTF","so how's Fukuoka?", 35, 20, 450, 255, 255, 255)
    dialogue7=  textsprite("gamefont\\ITCBLKAD.TTF","mostly same as always but look at you! you're big now!", 35, 20, 450, 255, 255, 255)
...
def mayaending():
    while True:
        mainscreen =MainScreen("graphics\\menu\\bgmenu.png")
        text= textsprite("gamefont\\ITCBLKAD.TTF","Maya's Ending", 70, 225, 270, 255, 255, 255)
...
def haremending():
    while True:
        mainscreen =MainScreen("graphics\\menu\\bgmenu.png")
        text= textsprite("gamefont\\ITCBLKAD.TTF","Harem Ending", 70, 225, 270, 255, 255, 255)
        call_sprite(text, "Image", mainscreen)
        e= event.wait()
        if e.type == MOUSEBUTTONDOWN:
            mainmenuscreen()
...
def aloneending():
    while True:
        mainscreen =MainScreen("graphics\\menu\\bgmenu.png")
        text= textsprite("gamefont\\ITCBLKAD.TTF","Forever Alone Ending", 70, 225, 270, 255, 255, 255)
        call_sprite(text, "Image", mainscreen)
        e= event.wait()
        if e.type == MOUSEBUTTONDOWN:
            mainmenuscreen()
